...
> ⚠️ Pendiente de actualizar: este diagrama no incluye todavía la tabla `tokens_invalidados` (se agregó después, para poder invalidar tokens JWT en el logout).
